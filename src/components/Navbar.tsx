    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-[#b3b3b3]">
            ...
            <nav className="flex w-full industrial-border-b h-12 items-center font-mono text-[10px] wide-tracking uppercase">
                {/* Menu Section */}
                <div className={`w-1/4 h-full industrial-border-r flex items-center px-6 gap-2 hover:bg-black/5 cursor-pointer transition-colors mercury-border ${mercuryClass}`}>

    ...
    return (
        <div className="min-h-screen flex flex-col">
            <div className="flex justify-between items-center px-6 md:px-12 py-3 border-b border-black/8">
                ...
                >
                    <span>‹</span> BACK TO {initialProduct.category.toUpperCase()}
                </button>
                {nextProduct && (
                    <Link
            ...
            <main className="flex-1 flex flex-col lg:flex-row">
                <div className="lg:w-[55%] bg-[#ece9e4]">
                ...
                <div className="lg:w-[45%] flex flex-col">
                    <div className="lg:sticky lg:top-20 flex flex-col h-auto lg:h-[calc(100vh-5rem)]">
                            ...
                            {sizes[0] !== "ONE SIZE" && (
                                <div className="border-t border-black/8 pt-5 pb-5">
                                    <div className="flex items-center justify-between mb-3">
                                        <p className="font-mono text-[11px] tracking-wider">SIZE</p>
                                        {sizeError && <span className="font-mono text-[10px] text-red-500">Please select a size</span>}
                                    </div>
                            ...
                            <div className="mt-2">
                                <div className="border-t border-black/8">
                                    <button onClick={() => toggleAccordion("details")} className="w-full flex items-center justify-between py-4 group">
                                        <span className="font-mono text-[11px] tracking-wider font-medium">PRODUCT DETAILS</span>
                                        ...
                                        <ul className="space-y-2 font-mono text-[11px] opacity-70 leading-relaxed pl-0 list-none">
                                            {initialProduct.details.split("·").map((detail, i) => (
                                                <li key={i} className="flex items-start gap-2">
                                                    <span className="opacity-30 mt-px">·</span>
                                                    <span>{detail.trim()}</span>
                                                </li>
                                            ))}
                                            <li className="flex items-start gap-2"><span className="opacity-30 mt-px">·</span><span>Imported</span></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                {sizeGuide && (
                                    <div className="border-t border-black/8">
                                        <button onClick={() => toggleAccordion("sizeguide")} className="w-full flex items-center justify-between py-4 group">
                                            <span className="font-mono text-[11px] tracking-wider font-medium">SIZE GUIDE</span>
                                        ...
                                        <div className={`overflow-hidden transition-all duration-300 ${openAccordion === "sizeguide" ? "max-h-96 pb-5" : "max-h-0"}`}>
                                            <p className="font-mono text-[10px] opacity-50 mb-4">All measurements are taken across the garment while laid flat.</p>
                                                ...
                                                <table className="w-full font-mono text-[10px]">
                                                    <thead>
                                                        <tr className="border-b border-black/10">
                                                            <th className="text-left py-2 pr-4 font-medium opacity-50">SIZE</th>
                                                    ...
                                                    <tbody>
                                                        {Object.entries(sizeGuide).map(([measurement, values]) => (
                                                            <tr key={measurement} className="border-b border-black/5">
                                                                <td className="py-2.5 pr-4 font-medium">{measurement}</td>
                                                                {sizes.map(s => {
                                ...
                                <div className="border-t border-black/8">
                                    <button onClick={() => toggleAccordion("shipping")} className="w-full flex items-center justify-between py-4 group">
                                        <span className="font-mono text-[11px] tracking-wider font-medium">SHIPPING & RETURNS</span>
                                    ...
                                    <div className={`overflow-hidden transition-all duration-300 ${openAccordion === "shipping" ? "max-h-60 pb-5" : "max-h-0"}`}>
                                        <div className="space-y-4 font-mono text-[11px] opacity-70 leading-relaxed">
                                            <div>
                                                <p className="font-medium opacity-100 mb-1">Shipping</p>
                                                <p>Standard shipping: Free on all orders</p>
                                                <p>Express shipping: $15.00 USD</p>
                                                <p>Estimated delivery: 5–10 business days</p>
                                            </div>
                                            <div>
                                                <p className="font-medium opacity-100 mb-1">Returns</p>
                                ...
                                <div className="border-t border-b border-black/8">
                                    <button onClick={() => toggleAccordion("care")} className="w-full flex items-center justify-between py-4 group">
                                        <span className="font-mono text-[11px] tracking-wider font-medium">CARE</span>
                                    ...
                                    <div className={`overflow-hidden transition-all duration-300 ${openAccordion === "care" ? "max-h-40 pb-5" : "max-h-0"}`}>
                                        <ul className="space-y-2 font-mono text-[11px] opacity-70 leading-relaxed pl-0 list-none">
                                            <li className="flex items-start gap-2"><span className="opacity-30">·</span> Machine wash cold</li>
                                            <li className="flex items-start gap-2"><span className="opacity-30">·</span> Do not bleach</li>
                                            <li className="flex items-start gap-2"><span className="opacity-30">·</span> Tumble dry low</li>
                                            <li className="flex items-start gap-2"><span className="opacity-30">·</span> Iron low if needed</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="shrink-0 px-6 md:px-10 lg:px-12 pb-6 pt-4 bg-[#b3b3b3]">
                            ...
                            >
                                {addedFeedback ? "✓ ADDED TO BAG" : `ADD TO BAG — ${initialProduct.price}`}
                            </button>
                        </div>
                    </div>
                </div>

...
import { getCyberValentineProducts } from "@/lib/products";

export default function CyberValentinePage() {
    const products = getCyberValentineProducts();

    return (
        <div className="flex flex-col min-h-screen">
            <CategoryHero
                title="CYBER VALENTINE '24"
                subtitle="LIMITED CAPSULE RELEASE. METALLIC ACCENTS, NUMBERED EDITIONS, AND EXCLUSIVE ACCESSORIES FOR THE DIGITAL ROMANTIC."
                code="CV24_SEQUENCE"
            ...
            <div className="max-w-7xl mx-auto w-full px-6 md:px-12 py-12">
                <div className="pt-8 border-t border-black/10 flex justify-between items-center opacity-30">
                    <div className="flex gap-4">
                        <span className="font-mono text-[8px]">[ CV_24 ]</span>
                        <span className="font-mono text-[8px] font-bold text-gold-muted">[ CAPSULE ]</span>
                    </div>

...
export default function HoodiesPage() {
    ...
    const content = {
        ...
        subtitle: mounted && language === "ES"
            ? "INTERFACES TÉRMICAS. CONSTRUCCIONES MODULARES CON SISTEMAS DE UTILIDAD OCULTOS Y ARQUITECTURAS OVERSIZED."
            : "THERMAL INTERFACES. MODULAR CONSTRUCTIONS WITH HIDDEN UTILITY SYSTEMS AND OVERSIZED ARCHITECTURES.",
        empty: mounted && language === "ES" ? "INVENTARIO_VACÍO" : "INVENTORY_EMPTY",
        label: mounted && language === "ES" ? "CAPA_TÉRMICA" : "THERMAL_LAYER"
    };
